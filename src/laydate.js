    ...
    lay.each(new Array(2), function (i) {
      ...
      var divHeader = lay.elem('div', {
        ...
        headerChild = [function () { //上一年
          var elem = lay.elem('i', {
            'class': 'fa fa-angle-double-left laydate-prev-y'
          });
          return elem;
        }(), function () { //上一月
          var elem = lay.elem('i', {
            'class': 'fa fa-angle-left laydate-prev-m'
          });
          return elem;
        }(), function () { //年月选择
          ...
          var elem = lay.elem('i', {
            'class': 'fa fa-angle-right laydate-next-m'
          });
          return elem;
        }(), function () { //下一年
          var elem = lay.elem('i', {
            'class': 'fa fa-angle-double-right laydate-next-y'
          });
          return elem;
        }()]
